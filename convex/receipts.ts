...
export const generateUploadUrl = mutation({
    args: {},
    handler: async (ctx) => {
        // generate a URL that the client can use to upload file
...
export const getReceiptById = query({
    ...
    handler: async (ctx, args) => {
        ...
        // verify user has accessed to this receipt
        if (receipt) {
...
// deleting a receipt and its file
export const deleteReceipt = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        // verify verify user has access to this receipt
        // const identity = await ctx.auth.getUserIdentity()
        // if (!identity) {
        //     throw new Error("Not authenticated")
        // }
...
export const updateReceiptWithExtractData = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        await ctx.db.patch(args.id, {
            ...
            items: args.items,
            status: "processed", // mark as processed now that we have extracted date
        })
